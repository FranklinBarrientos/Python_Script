...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        Initially, no clear in the room have been cleaned.
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        self.tiles[int(pos.y)][int(pos.x)] = True
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return sum([1 for y in range(self.height) for x in range(self.width) if self.tiles[y][x]==True])
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    anim.done()
    return float(sum(trials_steps)) / float(num_trials)
    """
    ...
    """
    ##redefinir esta funcion pues no trabaja como deberia
